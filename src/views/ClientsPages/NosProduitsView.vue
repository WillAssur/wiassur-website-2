  ...
  <b-row>
    <b-col class="mb-4" cols="12" md="6" lg="4" v-for="(item, index) in items" :key="index">
      <b-card style="min-height: 317px; height: 100%; width: 100%; padding: 10px; background: white; border: none; border-radius: 16px;">
        <img :src="'public/images/produits/' + item.icon" width="36" height="36" />
    ...
    <b-container>
      ...
      <b-row>
        <b-col class="mb-4" cols="12" md="6" lg="4" v-for="(product, index) in products" :key="index">
          <b-card  style=" min-height: 317px; height: 100%; width: 100%; padding: 10px; background: white; border:none; border-radius: 16px;">
            <div class="circle d-flex align-items-center justify-content-center" style="background: #61C0C7;"></div>
            <div class="d-flex flex-column align-items-start">
              <h5 class="fw-bold mt-3 mb-2 text-start">{{ product.title }}</h5>
              <p class="text-start" style="color: #080507; font-size: 16px; font-family: Avenir; font-weight: 400;">
    ...
    return {
      items: [
        ...
        },
        {
          ...
          icon: 'assurance-vie-prevoyance.svg',
        },
        {
...
.page {
  ...
  align-items: center;
  background-color: var(--White, #F6EEF3);
